{{ config(
 tags=['raw_report_postings_fbs', 'report_postings_fbs', 'report_postings', 'raw'],
 target='duckdb',
 schema='raw',
 materialized='table',
...
select *
from read_csv_auto('s3://dev-raw/reports/postings/{{ var("logical_date") }}/fbs_seller_postings_{{ var("logical_date") }}.csv', sep=';', header=true)
